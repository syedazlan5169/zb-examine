...
class StaffExaminationController extends Controller
{
     ...
     * Only the normalized search term is carried into generated pagination URLs.
     *
     * @return array{examinations: LengthAwarePaginator, search: string}
     */
    private function sidebarData(Request $request): array
    {
        ...
        return compact('examinations', 'search');
    }
}
